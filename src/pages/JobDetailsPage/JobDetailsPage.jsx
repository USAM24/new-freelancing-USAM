             ...
             <div className="flex justify-around mb-5">
                ...
                <div className='p-8 border-2 border-primary-50 rounded-lg mb-9 '>
                    ...
                    <div className='mb-4 flex justify-between py-6 border-b-2 border-[#F2F2F2]'>
                        <h2 className='font-medium mb-3 text-xl'>
                            10% fess  services on your project
                        </h2>
                ...
                <div className='flex flex-row justify-between py-8 '>
                    ...
                    <div className='flex flex-row justify-around '>
                     ...
                     <button className='py-3 px-12 border-2 border-primary-700 rounded-lg bg-primary-700 text-neutral-50 font-semibold outline-4'>Submit</button>
